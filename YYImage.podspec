Pod::Spec.new do |s|
  ...
  s.authors      = { 'ibireme' => 'mrdongyueyue@163.com' }
  s.social_media_url = 'http://blog.ibireme.com'
  s.homepage     = 'https://github.com/Mrdongyueyue/YYImage'
  s.platform     = :ios, '6.0'
  s.ios.deployment_target = '6.0'
  s.source       = { :git => 'https://github.com/Mrdongyueyue/YYImage.git', :tag => s.version.to_s }
